...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Queue returns persons in reverse order (Sue instead of Bob first), indicating PersonQueue is implemented as LIFO instead of FIFO.
    ...
    // Defect(s) Found: Queue returns persons in reverse order (Sue instead of Bob first).
    ...
    // Defect(s) Found: Queue returns persons in reverse order (Sue instead of Tim first).
    ...
    // Defect(s) Found: None - test passes correctly.
